...
const carCollections = [
  ...
  { name: 'Toyota Glanza', seats: 4, baggage: 3,image: "../../assets/sub-pages/car-rental/glanza.png"},
  { name: 'Toyota Innova ', seats: 6, baggage: 5 ,image: "../../assets/sub-pages/car-rental/innova.png"},
  { name: 'Toyota Crysta Luxury', seats: 6, baggage: 5,image: "../../assets/sub-pages/car-rental/crysta.png" },
  { name: 'Maruti Suzuki Ertiga', seats: 6, baggage: 4,image:"../../assets/sub-pages/car-rental/ertiga.png"},
  { name: 'Chevrolet Tavera', seats: 8, baggage: 6, image:"../../assets/sub-pages/car-rental/chevrolet-tavera.png" },
  { name: 'Tempo Traveller 12', seats: 12, baggage: 8,image:"../../assets/sub-pages/car-rental/tempo12.png" },
